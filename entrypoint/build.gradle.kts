...
dependencies {
    ...
    implementation("com.whichlicense.identification:license:0.3.2-SNAPSHOT")
    implementation("com.whichlicense.identification.license.backend:wasm:0.3.2-SNAPSHOT")
