...
dependencies {
    ...
    implementation("com.whichlicense.identification:license:0.7.1-SNAPSHOT")
    implementation("com.whichlicense.identification.license.backend:wasm:0.7.1-SNAPSHOT")
