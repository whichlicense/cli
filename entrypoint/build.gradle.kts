...
dependencies {
    ...
    implementation("com.whichlicense:sourcing:0.6.4-SNAPSHOT")
    implementation("com.whichlicense.sourcing:github:0.6.4-SNAPSHOT")
    ...
    implementation("com.whichlicense.identification:license:0.6.2-SNAPSHOT")
    implementation("com.whichlicense.identification.license.backend:wasm:0.6.2-SNAPSHOT")
