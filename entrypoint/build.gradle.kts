...
dependencies {
    ...
    implementation("com.whichlicense.identification:license:0.5.1-SNAPSHOT")
    implementation("com.whichlicense.identification.license.backend:wasm:0.5.1-SNAPSHOT")
