...
dependencies {
    ...
    implementation("com.whichlicense.identification:license:0.6.0-SNAPSHOT")
    implementation("com.whichlicense.identification.license.backend:wasm:0.6.0-SNAPSHOT")
